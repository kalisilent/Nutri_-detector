...
/// Full scan result: grade badge → nutrients → ingredient cards → additives.
class ResultScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final detail = ref.watch(scanDetailProvider(scanId));
    ...
    return Scaffold(
      ...
      body: detail.when(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                FilledButton(
                  onPressed: () => ref.refresh(scanDetailProvider(scanId)),
        ...
        data: (data) => _ResultBody(data: data),
      ),
    );
  }
}
      ...
      children: [
        ...
        Card(
          child: Padding(
            ...
            child: Text(
              'Educational information based on Nutri-Score and the NOVA '
              'classification. Not medical advice.',
